...
Retrieves the user's gem inventory from their GitHub gist.
...
1. **List Available Gems**

**GET /data/gems**

List all available gems and their properties.

2. **List Available Skills**

**GET /data/skills**

List all available skills and their properties.

3. **List Available Equipment**

**GET /data/equipment**

List all available equipment and their properties.

## Data Structures

### Essences

Essences are organized in an optimized structure with the following components:
...
The essence structure provides efficient lookups by both slot and skill, with
additional metadata for tracking versions and updates.
